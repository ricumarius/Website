...
CREATE DATABASE nume_baza_date ENCODING 'UTF-8' LC_COLLATE 'ro-RO-x-sic' LC_CTYPE 'ro_RO' TEMPLATE template0;
...
CREATE USER user_loudmusic WITH ENCRYPTED PASSWORD 'loudmusic';
GRANT ALL PRIVILEGES ON DATABASE proiect_loudmusic TO loudmusic ;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO loudmusic;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO loudmusic;